...
public class LetrasMain {
	...
	public static void main(String[] args) {
		...
		letras.mostrarMensaje("Escribe un texto y te mostrare el numero de vocales, consonantesc simbolos y numeros");
		...
		int totalSimbolos = contador.contarSimbolo(palabra);
